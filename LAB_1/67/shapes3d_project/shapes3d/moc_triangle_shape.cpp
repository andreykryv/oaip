...
struct qt_meta_stringdata_TriangleShape_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TriangleShape_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TriangleShape_t qt_meta_stringdata_TriangleShape = {
    {
QT_MOC_LITERAL(0, 0, 13) // "TriangleShape"
...
static const uint qt_meta_data_TriangleShape[] = {
...
QT_INIT_METAOBJECT const QMetaObject TriangleShape::staticMetaObject = { {
    QMetaObject::SuperData::link<PolygonShape::staticMetaObject>(),
    qt_meta_stringdata_TriangleShape.data,
    qt_meta_data_TriangleShape,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TriangleShape::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TriangleShape.stringdata0))
