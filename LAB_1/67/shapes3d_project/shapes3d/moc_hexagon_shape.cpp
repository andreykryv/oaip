...
struct qt_meta_stringdata_HexagonShape_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_HexagonShape_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HexagonShape_t qt_meta_stringdata_HexagonShape = {
    {
QT_MOC_LITERAL(0, 0, 12) // "HexagonShape"
...
static const uint qt_meta_data_HexagonShape[] = {
...
QT_INIT_METAOBJECT const QMetaObject HexagonShape::staticMetaObject = { {
    QMetaObject::SuperData::link<PolygonShape::staticMetaObject>(),
    qt_meta_stringdata_HexagonShape.data,
    qt_meta_data_HexagonShape,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *HexagonShape::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HexagonShape.stringdata0))
