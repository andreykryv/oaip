...
struct qt_meta_stringdata_StarShape_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StarShape_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StarShape_t qt_meta_stringdata_StarShape = {
    {
QT_MOC_LITERAL(0, 0, 9) // "StarShape"
...
static const uint qt_meta_data_StarShape[] = {
...
QT_INIT_METAOBJECT const QMetaObject StarShape::staticMetaObject = { {
    QMetaObject::SuperData::link<PolygonShape::staticMetaObject>(),
    qt_meta_stringdata_StarShape.data,
    qt_meta_data_StarShape,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *StarShape::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StarShape.stringdata0))
