...
Item {
    ...
    // ─────────────────────────────────────────────────────────
    //  Popup: форма добавления / редактирования студента
    //  Один и тот же Popup используется для обоих режимов.
    //  editIndex == -1  →  добавление
    //  editIndex >= 0   →  редактирование
    // ─────────────────────────────────────────────────────────
    Popup {
        id: studentPopup
        property int editIndex: -1   // -1 = добавление, иначе = редактирование
        ...
        function openEdit(index) {
            ...
            var s = studentBE.getStudent(index)
            if (!s) return
            editIndex = index
            grpInput.text = s.grp
            nmInput.text  = s.nm
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    color: "#ffffff"
                    font.pixelSize: 14; font.family: "Arial"; font.weight: Font.Bold
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: "Зимняя сессия (5 оценок):"
                        color: cNavy; font.pixelSize: 12; font.family: "Arial"; font.weight: Font.Bold
                    }
                    RowLayout {
    ...
    // ── Диалоги файлов (скопировано с DatesPage) ─────────────
    AppFileDialog {
        id: openDialog; mode: "open"
        onAccepted: {
            if (typeof studentBE !== "undefined") studentBE.openFile(selectedFile)
        }
    }
    AppFileDialog {
        id: saveDialog; mode: "save"
        onAccepted: {
            if (typeof studentBE !== "undefined") studentBE.saveFile(selectedFile)
        }
    }

    // ── Диалог ошибок (скопировано с DatesPage) ──────────────
    ...
    ColumnLayout {
        ...
        AppToolBar {
            ...
            AppInput {
                id: searchInput; implicitWidth: 150; placeholderText: "Поиск"
                onTextChanged: {
                    if (typeof studentBE !== "undefined")
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        // Вспомогательная функция — стрелка направления
                        // Отображается рядом с активной колонкой сортировки
                        Repeater {
                            model: [
                                {lbl:"#",                   wd:40,  col:""},
                            ...
                            delegate: Item {
                                ...
                                // Кликабельные заголовки для сортируемых колонок
                                MouseArea {
                                    anchors.fill: parent
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        text: modelData.lbl
                                        color: (typeof studentBE !== "undefined" && studentBE.sortColumn === modelData.col && modelData.col !== "")
                                               ? "#ffffff" : "#a8c0dc"
                                    ...
                                    Text {
                                        ...
                                        color: "#00bcd4"
                                        font.pixelSize: 12; font.family: "Arial"; font.weight: Font.Bold
                                    }
                                }
                            }
                        }
                            ...
                            Item {
                                ...
                                Row {
                                    ...
                                    AppButton {
                                        ...
                                        // Открываем форму редактирования с данными этой строки
                                        onClicked: {
                                            selectedRow = index
        ...
        AppToolBar {
            ...
            AppButton {
                // Стрелка меняется в зависимости от текущей сортировки
            ...
            Text {
                text: typeof studentBE !== "undefined" ? studentBE.expelCount.toString() : "2"
                color:cRed; font.pixelSize:13; font.family:"Arial"; font.weight:Font.Bold
            }
            ...
            Text {
                text: typeof studentBE !== "undefined" ? studentBE.debtCount.toString() : "2"
                color:"#e65100"; font.pixelSize:13; font.family:"Arial"; font.weight:Font.Bold
            }
            ...
            Text {
                text: typeof studentBE !== "undefined" ? studentBE.okCount.toString() : "2"
                color:cGreen; font.pixelSize:13; font.family:"Arial"; font.weight:Font.Bold
            }
            Item { Layout.fillWidth:true }
        }
    }
